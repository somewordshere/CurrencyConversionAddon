...
- **Manual installation:** Download the latest [Chrome build](release/2.1.1/twinprice-2.1.1-chrome.zip) or [Firefox build](release/2.1.1/twinprice-2.1.1-firefox.zip), extract it, and load it through the browser's extension-development page. The Firefox build requires Mozilla signing for permanent installation.
